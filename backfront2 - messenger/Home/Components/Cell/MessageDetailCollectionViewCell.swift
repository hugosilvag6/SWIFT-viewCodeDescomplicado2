...
extension MessageDetailCollectionViewCell {
   ...
   func setUserName(userName: String) {
      let attributeText = NSMutableAttributedString(string: userName, attributes: [NSAttributedString.Key.font : UIFont(name: CustomFont.poppinsMedium, size: 16) ?? UIFont(), NSAttributedString.Key.foregroundColor:UIColor.darkGray])
